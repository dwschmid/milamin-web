...
async function createSpchol(moduleArg = {}) {
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("spchol-mt.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("spchol-mt.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  initMainThread() {
    var pthreadPoolSize = navigator.hardwareConcurrency || 8;
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("spchol-mt.js", import.meta.url), {
      "type": "module",
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_getdents64, ___syscall_ioctl, ___syscall_openat, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var _spchol_threads = Module["_spchol_threads"] = makeInvalidEarlyAccess("_spchol_threads");

var _spchol_factor = Module["_spchol_factor"] = makeInvalidEarlyAccess("_spchol_factor");

var _spchol_solve = Module["_spchol_solve"] = makeInvalidEarlyAccess("_spchol_solve");

var _spchol_nnzL = Module["_spchol_nnzL"] = makeInvalidEarlyAccess("_spchol_nnzL");

var _spchol_free = Module["_spchol_free"] = makeInvalidEarlyAccess("_spchol_free");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["spchol_threads"] != "undefined", "missing Wasm export: spchol_threads");
  assert(typeof wasmExports["spchol_factor"] != "undefined", "missing Wasm export: spchol_factor");
  assert(typeof wasmExports["spchol_solve"] != "undefined", "missing Wasm export: spchol_solve");
  assert(typeof wasmExports["spchol_nnzL"] != "undefined", "missing Wasm export: spchol_nnzL");
  assert(typeof wasmExports["spchol_free"] != "undefined", "missing Wasm export: spchol_free");
  ...
  _spchol_threads = Module["_spchol_threads"] = createExportWrapper("spchol_threads", wasmExports["spchol_threads"], 1);
  _spchol_factor = Module["_spchol_factor"] = createExportWrapper("spchol_factor", wasmExports["spchol_factor"], 4);
  _spchol_solve = Module["_spchol_solve"] = createExportWrapper("spchol_solve", wasmExports["spchol_solve"], 2);
  _spchol_nnzL = Module["_spchol_nnzL"] = createExportWrapper("spchol_nnzL", wasmExports["spchol_nnzL"], 1);
  _spchol_free = Module["_spchol_free"] = createExportWrapper("spchol_free", wasmExports["spchol_free"], 1);
